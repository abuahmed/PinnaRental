...
//using PinnaRent.Core.Repository;
//using PinnaRent.Core.Repository.Interfaces;

namespace PinnaRent.Core.CustomValidationAttributes
{
    ...
    public class UniqueCustomer : ValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            //IUnitOfWork unitOfWork = new UnitOfWork(new PinnaRent.DAL.DbContextFactory().Create());
