...
namespace PinnaRent.WPF.ViewModel
{
    public class BackupRestoreViewModel : ViewModelBase
    {
        ...
        public BackupRestoreViewModel()
        {
            ...
            //if (Singleton.Edition == PinnaRentEdition.ServerEdition)
            //{
        ...
        public void BackupCompactData(object obj)
        {
            try
            {
                ...
                try
                {
                    ...
                    var destFileName = "PinnaRentDb_" + DateTime.Now.ToLongDateString() + "_Backup.sdf";
                    ...
                    if (sourceFile.Exists)
                    {
                        ...
                        MessageBox.Show("Database Backup taken Successfully " + Environment.NewLine +
            ...
            try
            {
                ...
                if (open.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        if (destFile.Exists)
                        {
                            var path = Environment.GetFolderPath(Environment.SpecialFolder.CommonDocuments) + "\\PinnaRentBACKUP" + "\\";
                            if (!Directory.Exists(path))
                                Directory.CreateDirectory(path);
                            var pathfile = Path.Combine(path, "PinnaRentDb_" + DateTime.Now.Ticks.ToString() + ".sdf");
                        ...
                        MessageBox.Show("Database Restored Successfully!" + Environment.NewLine +
                            ...
                            "Restore Success",MessageBoxButton.OKCancel,MessageBoxImage.Information);
                        CloseWindow(obj);
        ...
        //                    var bkpDatabase = new Backup { Action = BackupActionType.Database, Database = "PinnaRentDb" };
        ...
        //            {
        //                //this.Cursor = Cursors.WaitCursor;                            
        //                var rstDatabase = new Restore { Action = RestoreActionType.Database, Database = "PinnaRentDb" };
