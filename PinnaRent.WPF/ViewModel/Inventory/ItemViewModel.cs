...
namespace PinnaRent.WPF.ViewModel
{
    public class ItemViewModel : ViewModelBase
    {
        ...
        private ICommand _addNewItemViewCommand, _saveItemViewCommand, _deleteItemViewCommand,
                         _addNewCategoryCommand, _addNewUomCommand, _refreshListCommand;
            ...
            set
            {
                ...
                if (SearchText != "")
                {
                    Items = new ObservableCollection<ItemDTO>
                        ...
                        c.Number.ToLower().Contains(value.ToLower())).ToList());
                }
                else
                {
        ...
        public CategoryDTO SelectedCategoryForSearch
        {
            ...
            set
            {
                ...
                var itemsList = ItemsList.Where(iq => iq.Category.DisplayName == SelectedCategoryForSearch.DisplayName);
                Items = new ObservableCollection<ItemDTO>(itemsList);
            }
        }
        #endregion
