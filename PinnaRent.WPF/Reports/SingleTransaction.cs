...
namespace PinnaRent.WPF.Reports {
    ...
    public class SingleTransaction : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PinnaRent.WPF.Reports.SingleTransaction.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSingleTransaction : Component, ICachedReport {
        
        public CachedSingleTransaction() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SingleTransaction rpt = new SingleTransaction();
            rpt.Site = this.Site;
            return rpt;
        }
